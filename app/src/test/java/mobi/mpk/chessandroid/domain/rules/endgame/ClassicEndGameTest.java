package mobi.mpk.chessandroid.domain.rules.endgame;
...
import mobi.mpk.chessandroid.domain.rules.rule.end.game.ClassicEndGameRule;
import mobi.mpk.chessandroid.domain.rules.rule.end.game.EndGameRule;
